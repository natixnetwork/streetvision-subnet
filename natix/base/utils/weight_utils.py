...
def process_weights_for_netuid(
    ...
    # Handle all zeros case or insufficient valid weights
    if non_zero_weights.size == 0 or non_zero_weights.size < min_allowed_weights or metagraph.n < min_allowed_weights:
        bittensor.logging.warning("No valid weights or insufficient weights, assigning all weight to burn uid (uid 0).")
        # Give all weight to burn uid (uid 0)
