...
python base_miner/datasets/create_video_dataset.py --input_dir ~/.cache/natix/real/video \
       --frames_dir ~/.cache/natix/train_frames \
       --dataset_dir ~/.cache/natix/train_dataset/real_frames \
       --num_videos 500 \
       --frame_rate 5 \
       --max_frames 24 \
